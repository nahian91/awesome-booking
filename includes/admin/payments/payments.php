...
<div class="abeg-inner-tab-content">
    ...
    switch($sub_tab){
        case 'transactions':
            include ABEG_PLUGIN_PATH.'includes/admin/tabs/payments/transactions.php';
            break;
        case 'refunds':
            include ABEG_PLUGIN_PATH.'includes/admin/tabs/payments/refunds.php';
            break;
        default:
            include ABEG_PLUGIN_PATH.'includes/admin/tabs/payments/methods.php';
            break;
    }
    ?>
</div>
